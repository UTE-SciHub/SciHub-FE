...
const ReviewResult: React.FC<ReviewResultProps> = ({ topic, reviewData }) => {
    ...
    const hasPassedMinimumScores = CRITERIA_DETAILS.every(
        (criteria) => reviewData[criteria.id] >= criteria.minScore
    );
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <h3 className="font-medium">
                                {isApproved ? "Đủ điều kiện phê duyệt" : "Không đủ điều kiện phê duyệt"}
                            </h3>
